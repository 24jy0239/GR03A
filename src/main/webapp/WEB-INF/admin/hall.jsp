                ...
                <div class="order-card">
                    <div class="col name-col">
                        ...
                        <div class="info-row-3">
                            <div class="info-box"><span class="info-label">卓番</span><span class="info-value">${item.tableNum}</span></div>
                            <div class="info-box"><span class="info-label">経過</span><span class="info-value timer" data-order-time="${item.orderTime}">00:00</span></div>
                            <div class="info-box"><span class="info-label">数量</span><span class="info-value">${item.quantity}</span></div>
                        </div>
                    </div>
                    ...
                    <div class="col action-col">
                        <c:choose>
                            <c:when test="${item.itemStatus == 2}">
                                <form action="${pageContext.request.contextPath}/admin/hall" method="post" style="width:100%; display:flex; justify-content:center;">
