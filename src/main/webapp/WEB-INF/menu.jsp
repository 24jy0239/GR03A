...
<body>
    <div class="header">
        <div class="header-content">
            ...
            <div>
                ...
                <a href="<%= request.getContextPath() %>/reset" 
            ...
            %>
                <div class="dish-card">
                    ...
                    <div class="dish-info">
                        ...
                        <div class="dish-price">¥<%= formatter.format(dish.getPrice()) %></div>
                        
                        <form action="<%= request.getContextPath() %>/menu" method="post" class="add-to-cart">
                ...
                <% for (CartItem item : cart) { %>
                    <div class="cart-item">
                        ...
                        <div class="cart-item-controls">
                            <form action="<%= request.getContextPath() %>/menu" method="post" style="display: inline;">
    ...
    <div class="cart-footer">
        <div class="cart-footer-content">
            <div class="cart-info">
                <span>カート: <%= cartCount %> 品</span>
                <span class="cart-total">合計: ¥<%= formatter.format(cartTotal) %></span>
            </div>
            <form action="<%= request.getContextPath() %>/order-confirm" method="get">
