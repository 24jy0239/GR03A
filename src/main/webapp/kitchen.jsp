    ...
    <div class="header">
        <div class="header-content">
            ...
            <div class="nav-links">
                ...
                <a href="${pageContext.request.contextPath}/">🏠 トップ</a>
            </div>
        </div>
    </div>
                ...
                <div class="section">
                    ...
                    <div class="order-grid">
                        <c:forEach var="item" items="${kitchenItems}">
                            <div class="order-card status-${item.itemStatus} priority-${item.priority}">
                                <div class="table-badge">
                                    テーブル ${item.tableNum} 番
                                </div>
                                ...
                                <div class="time-info">
                                    ...
                                    <div class="elapsed-time ${item.priority}">
                                        経過: ${item.elapsedTimeText}
                                    </div>
                                </div>
                                ...
                                <div class="action-buttons">
                                    <c:choose>
                                        <c:when test="${item.itemStatus == 0}">
                                            <form action="${pageContext.request.contextPath}/admin/kitchen" method="post" style="flex: 1;">
